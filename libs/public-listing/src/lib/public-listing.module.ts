...
@NgModule({
  imports: [CommonModule, MatDatepickerModule,  GoogleMapsModule, FlexModule, MatInputModule, MatIconModule, MatSelectModule, MatCardModule, MatButtonModule, MatDialogModule],
